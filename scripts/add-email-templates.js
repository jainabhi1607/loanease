...
const emailTemplates = [
  // Welcome Email (sent to new referrer)
  {
    ...
    value: 'Welcome to Loanease - {Entity Name}',
...
<p>Your Loanease registration has been a success. In order to access the portal and submit your first opportunity, please use the details below.</p>

<p>Username: {UserName}<br>
Password: {Password}</p>

<p>You can reset your password at any time by going to https://app.loanease.com/reset-password</p>
...
<p>For application status updates please email
   <a href="mailto:apps@loanease.com" target="_blank" rel="noopener">apps@loanease.com</a>
</p>
<p>For Referral Partner queries please email
   <a href="mailto:partners@loanease.com" target="_blank" rel="noopener">partners@loanease.com</a>
</p>`,
  ...
  // Referrer Agreement Email (sent to new referrer with PDF attachment)
  {
    ...
    value: 'Loanease - Referrer Agreement - {Entity Name}',
...
<p>Welcome to Loanease! We are excited to have you on board and look forward to a successful partnership.</p>
...
<p>For Referral Partner queries please email
  ...
  },
  {
    ...
    value: `<p>A new Referrer has signed-up to Loanease. Please find the details below:</p>
<ul>
...
<p>Your Loanease registration has been a success. In order to access the portal, please use the details below.</p>
