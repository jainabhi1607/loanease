...
export default function ReferrerClientDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const fetchClientDetails = async () => {
    try {
      const response = await fetch(`/api/referrer/clients/${clientId}`);
    ...
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="text-center">
          ...
          <Button onClick={() => router.push('/referrer/clients')} className="mt-4">
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="mb-6 flex items-center gap-4">
        <button
          onClick={() => router.push('/referrer/clients')}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-[#02383B] rounded-lg p-[40px]">
