...
INSERT INTO global_settings (setting_key, setting_value, setting_type, description) VALUES
  ...
  ('referrer_fees', '30% (inclusive of GST) of the net upfront commission and 20% (inclusive of GST) of the net trail commission received by ClueCommercial from the Lender (as defined in the definition of Referral Fees in Schedule 1).', 'textarea', 'Referrer fees text')
